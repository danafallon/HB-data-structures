...
def sort_by_cohort(filename):
    ...
    for line in cohort_data:
        ...
        student_ta = student_data[3]
        student_cohort = student_data[4]

        if student_cohort == 'Winter 2015':
            winter_15.append(student_name)
        elif student_cohort == 'Spring 2015':
            spring_15.append(student_name)

        if student_ta != "":
            if student_ta not in tas:
                tas.add(student_ta)
...
def all_students_tuple_list(filename):
    ...
    for line in cohort_data:
        student_data = line.rstrip().split("|")
        first_name, last_name, house, student_ta, cohort = student_data
